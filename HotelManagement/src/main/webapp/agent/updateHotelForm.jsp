							...
							<div class="home-tab">
							    <div class="container mt-5">
									<div
										...
										<div class="col-md-8">
										<%@ page import="models.Hotel, dao.HotelDAO"%>
											...
											<form method="post" action="${pageContext.request.contextPath}/agent/dashboard">
												<div class="form-row">
														<input type="hidden" name="action" class="form-control" value="updateHotel"/>
														<input type="hidden" name="id" class="form-control" value="<%= hotel.getId() %>"/>
													...
													<div class="form-group mb-3 col-md-6">
														<label for="city">City</label> <input
															...
															id="city" value="<%=hotel.getCity() %>">
													</div>
												</div>
												<div class="form-group mb-3 col-md-6">
													<label for="stars">Stars</label> 
													<select name="stars" class="form-select" id="stars">
													  <option selected value="<%= hotel.getStars() %>" >${hotel.stars }</option>
												...
												<div class="form-group mb-3 col-md-6">
														...
														<textarea name="description" class="form-textarea"
															id="description" value="<%= hotel.getDescription() %>"></textarea>
													</div>
                                                <div class="form-group mb-3 col-md-6">
														<label for="image">Image Path</label> <input
															type="file" name="image" class="form-control"
															id="image" value="<%= hotel.getImage() %>">
													</div>
