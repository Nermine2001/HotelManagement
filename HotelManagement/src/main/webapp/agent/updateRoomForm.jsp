							...
							<div class="home-tab">
							   <div class="container mt-5">
									<div
										...
										<div class="col-md-8">
										<%@ page import="java.util.*,models.RoomType,models.Hotel, dao.RoomTypeDAO, dao.HotelDAO"%>
											...
											if (idParam == null || idParam.trim().isEmpty()) {
												out.println("<p style='color:red;'>Error: No ID provided!</p>");
											} else {
												int id = Integer.parseInt(idParam);

												// Charger les informations de l'agent en utilisant l'ID
												RoomType room = RoomTypeDAO.getRoom(id);
												if (room == null) {
													out.println("<p style='color:red;'>Error: No agent found with ID " + id + ".</p>");
												} else {
											%>
											<form method="post" action="${pageContext.request.contextPath}/agent/dashboard">
												<div class="form-row">
														<input type="hidden" name="action" class="form-control" value="updateRoom">
														<input type="hidden" name="id" class="form-control" value="<%= room.getId() %>"/>
													...
													<div class="form-group mb-3 col-md-6">
														<label for="capacity">Capacity</label> <input
															...
															id="capacity" value="<%= room.getCapacity() %>">
													</div>
												</div>
												<div class="form-group mb-3 col-md-6">
												...
												<div class="form-group mb-3 col-md-6">
													...
													<select name="hotelId" class="form-select" id="hotelId">
													   <option selected value="<%= room.getHotelId() %>"><%= room.getHotelId() %></option>
													   <% for (Hotel hotel : hotels) { %>
                            <!-- Exclure l'hôtel actuel pour éviter des doublons -->
